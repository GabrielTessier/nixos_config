{ pkgs }:
pkgs.writeShellScriptBin "emoji-script" ''
...
🇬🇧 flag united kingdom great britain nation country banner british UK english england union jack
...
🇻🇬 flag british virgin islands bvi flag nation country banner
🇻🇮 flag US virgin islands us flag nation country banner u s
